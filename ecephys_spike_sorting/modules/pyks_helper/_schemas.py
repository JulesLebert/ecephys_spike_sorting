...
class pyksParams(DefaultSchema):
...
class pyksHelperParameters(DefaultSchema):
    ...
    pyks_params = Nested(pyksParams, required=False, help='Parameters used to auto-generate a Kilosort2 config file')

class InputParameters(ArgSchema):
    
    kilosort_helper_params = Nested(pyksHelperParameters)
